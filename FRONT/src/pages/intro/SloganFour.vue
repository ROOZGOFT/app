    ...
    <main class="row text-white text-center">
      ...
      <div class="col-12 fullscreen" style="display: flex;flex-direction: column; justify-content: center;">
        ...
        <p class="text-body2 q-px-md ligatures text-grey">
          صحبت و تعامل آنلاین با جامعه روزگفت
        </p>

        <div style="position: relative;">
          <q-img :style="{ 'margin': $q.screen.height > 800 ? '30px auto 0px' : '10px auto', 'filter': 'blur(0.5rem)' }"
            :width="$q.screen.height < 800 ? '70%' : '100%'" src="../../assets/community.webp" />
